...
<!--
DOCUMENT MAP (Stand 2026-09-24):
- Diese Datei: Mermaid-Flowchart der Investigationspfade (Start bis A2ca19 Test-Bug-Fix, Erweiterung A2ca20-A2ca27b Ququint-Arc 2026-06-19 -> 2026-09-24).
- 11 Sibling-Files, davon 4 CURRENT (Atomkern, SYNTHESIS, QA_IMPL, LATORE), 2 SUPERSEDED (BRIDGE, SAEULE1), 5 REFERENCE.

Sibling-Topologie:
  CURRENT (primary):   RIEMANN_HYPOTHESIS_AND_NUCLEAR_STRUCTURE.md (Sections 1-9 + §10.1-10.19)
  CURRENT (master):    SYNTHESIS_2026_06_10.md (Sections A-Q, R, T, U + §Z.11-18)
  CURRENT (master):    QUANTUM_ARCHITECTURE_IMPLEMENTATION.md (Mermaid-Architektur + QPU-Updates bis 2026-09-24)
...
Mermaid-Flowchart der Investigationspfade vom Start (Divergence Detected) bis A2ca19 (Test-Bug-Fix 2026-06-17) und weiter über den Ququint-Arc A2ca20–A2ca27 (QPU-VQE+VQD-Meilenstein, Pillar 4 GF(5), §Z.11–18) bis zur nächsten Phase (H-STAR-5-Ausführung). Visuell orientiert; **kanonische Text-Doku ist [`RIEMANN_HYPOTHESIS_AND_NUCLEAR_STRUCTURE.md`](RIEMANN_HYPOTHESIS_AND_NUCLEAR_STRUCTURE.md)**.
...
| [`SYNTHESIS_2026_06_10.md`](SYNTHESIS_2026_06_10.md) | **CURRENT (master)** | SciMind-Verdikte, strategische Vektoren (Sections A–Q, R, T, U + §Z.11–18) |
| [`QUANTUM_ARCHITECTURE_IMPLEMENTATION.md`](QUANTUM_ARCHITECTURE_IMPLEMENTATION.md) | **CURRENT (master)** | Mermaid-Architektur + QPU-Update-Log (bis 2026-09-24) |
| [`LATORE_TENSION_NOTE.md`](LATORE_TENSION_NOTE.md) | **CURRENT (pre-preprint)** | Latorre–Sierra-Spannung + §11 Asymptotik |
| [`PLAN.md`](PLAN.md) | HISTORICAL+EXTENSION | Phases 1–4 DONE; Phase 5 (QUQUINT) DONE; Phase 6 (H-STAR-5-Ausführung) NEXT |
...
graph TD
    ...
    A2ca9v --> A2ca9w[Section 6.5.16/17 + LATORE_TENSION_NOTE.md dokumentiert]
    ...
    A2ca9z -."KONSEQUENZ: Latorre-Spannung ist FUNDAMENTALE Disagreement, nicht finite-N-Artefakt".-> A2ca9za[Section 11 LATORE_TENSION_NOTE.md: Asymptotic Addendum]
    A2ca9z -."KONSEQUENZ: Latorre-Spannung ist FUNDAMENTALE Disagreement, nicht finite-N-Artefakt".-> A2ca9za[Section 11 LATORE_TENSION_NOTE.md: Asymptotic Addendum]
    ...
    A2ca11e -."SECTION 11 LATORE_TENSION_NOTE.md".-> A2ca11f[Asymptotic Addendum dokumentiert, Abstract aktualisiert]
    ...
    A2ca13a["||H_diag, Re(H_PT)||_F = 0, identische Eigenwerte"]
    ...
    %% A2ca20: TOKEN1 false-positives #2/#3 (2026-06-19/20, SYNTHESIS T/U)
    A2ca19e -."STRESS".-> A2ca20[TOKEN1 false-positive #2: exit 143 SIGTERM nach 10-min-Timeout]
    A2ca20 -."SYSTEMATISCH".-> A2ca20a[false-positive #3 bestätigt: Diagnose-DONE != Run-Faehigkeit, Statevector-Fallback]

    %% A2ca21: TOKEN1 echt offen (2026-07-21)
    A2ca20a -."31-TAGE-BLOCKADE-ENDE".-> A2ca21[2026-07-21: TOKEN1 echt offen, 18 historische QPU-Jobs retroaktiv inventarisiert]

    %% A2ca22: QPU-VQE+VQD-Meilenstein (2026-07-21)
    A2ca21 -."ERSTER-ECHTER-LAUF".-> A2ca22[QPU-VQE+VQD Fez/TOKEN1, Job d9fidihhtsac739fg3n0, E_0 = 2.1398]
    A2ca22 -."CONFIRMED".-> A2ca22a[H1/H3 QPU-confirmed, bias_PT_re = -0.0119, drei-Pfad-Konsistenz]
    A2ca22 -."REPRODUZIERBARKEIT".-> A2ca22b[Run 2 + Meta-Analysis, 5 strategische Vektor-Updates]

    %% A2ca23: Pillar 4 GF(5) implementiert (2026-07-21)
    A2ca22a -."ARCHITEKTUR".-> A2ca23[Pillar 4 Ququint GF5: Polynom-Ring + Gates + Simulator, H_PT_5 = H_PT_4 bit-genau, 402 Tests]

    %% A2ca24: §Z.11-14 QUQUINT auf IBMQ (2026-09-15)
    A2ca23 -."PHASE-1-3".-> A2ca24[§Z.11-14 EXPERIMENT 029-032: Verschränkung, Emulation, Aer-Noise 0 QPU]
    A2ca24 -."PREREG".-> A2ca24a[md5 18fb1e62 VOR Hardware gefroren]
    A2ca24a -."QPU".-> A2ca24b[Fez-Lauf dakjk9hhvn6c73cvr1cg: phi V 0.625, sep V 0.166, alle 3 Bänder CONFIRMED]
    A2ca24a -."ISA-REALITAET".-> A2ca24c[ISA 370 2q, phi_D 81 vs Soll 45 -> Leakage-Tabelle, QUQUINT_QPU_VIABLE A-]

    %% A2ca25: Steelman V1-V4 (2026-09-23)
    A2ca24b -."STEELMAN".-> A2ca25[§Z.15/16: 4/4 Prereg-Freeze vor Evaluation, 0 QPU]
    A2ca25 -."V1".-> A2ca25a[PARTIAL: Leakage-Struktur real, Sieb-Portal gescheitert]
    A2ca25 -."V2".-> A2ca25b[REFUTED + NEBENFUND: Witness rank-trivial, Ramanujan-Fingerprint B NEU]
    A2ca25 -."V3".-> A2ca25c[INKONKLUSIV DEGENERAT: GUE-Konstante 0.5359 -> 0.5996 korrigiert]
    A2ca25 -."V4".-> A2ca25d[CONFIRMED: κ* = 62.26, Rough-Modell 62.31 trifft 0.1%, QUQUINT_THRESHOLD_CROSSOVER A-]

    %% A2ca26: Pakete 1-4 (2026-09-24)
    A2ca25d -."PAKET-1".-> A2ca26[§Z.17: 033 α-Trennung INKONKLUSIV - ISA schliesst 0.3%, 45-cx nicht, Mechanismus revidiert]
    A2ca26 -."PAKET-2".-> A2ca26a[§Z.17: 034 Ramanujan REPLICATED, exaktes Modell m-5²/4dm, Vektor B+]
    A2ca26 -."PAKET-3".-> A2ca26b[§Z.18: 035 V5 Kingston CONFIRMED, Job daqaeteekp0c73aqetdg, bias +0.0074, KINGSTON A-]
    A2ca26 -."PAKET-4".-> A2ca26c[§Z.18: 036 H-STAR-5 HYPOTHESE registriert, md5 f915729e, Score 7/10, 0 QPU]

    %% A2ca27: nächste Phase
    A2ca26c -."NÄCHSTE-PHASE".-> A2ca27[H-STAR-5 Ausführung: Ausführungs-Prereg -> Aer-Ensemble 0 QPU -> QPU-Spot nur bei sichtbarer Trennung]
    A2ca26c -."FALLBACK".-> A2ca27b[H-STAR-5b: VQE-Hessian/Wishart-Landschaft als Observable, Score 6]
    ...
    style A2ca20 fill:#f96,stroke:#333,stroke-width:2px
    style A2ca20a fill:#9f9,stroke:#333,stroke-width:2px
    style A2ca21 fill:#5f5,stroke:#333,stroke-width:3px
    style A2ca22 fill:#5f5,stroke:#333,stroke-width:3px
    style A2ca22a fill:#5f5,stroke:#333,stroke-width:2px
    style A2ca22b fill:#9f9,stroke:#333,stroke-width:2px
    style A2ca23 fill:#9f9,stroke:#333,stroke-width:2px
    style A2ca24 fill:#9f9,stroke:#333,stroke-width:2px
    style A2ca24a fill:#5f5,stroke:#333,stroke-width:2px
    style A2ca24b fill:#5f5,stroke:#333,stroke-width:3px
    style A2ca24c fill:#fc9,stroke:#333,stroke-width:2px
    style A2ca25 fill:#9f9,stroke:#333,stroke-width:3px
    style A2ca25a fill:#fc9,stroke:#333,stroke-width:2px
    style A2ca25b fill:#f96,stroke:#333,stroke-width:2px
    style A2ca25c fill:#fc9,stroke:#333,stroke-width:2px
    style A2ca25d fill:#5f5,stroke:#333,stroke-width:3px
    style A2ca26 fill:#fc9,stroke:#333,stroke-width:2px
    style A2ca26a fill:#9f9,stroke:#333,stroke-width:2px
    style A2ca26b fill:#5f5,stroke:#333,stroke-width:2px
    style A2ca26c fill:#5f5,stroke:#333,stroke-width:2px
    style A2ca27 fill:#ff9,stroke:#333,stroke-width:3px
    style A2ca27b fill:#fc9,stroke:#333,stroke-width:2px
```
...
|---|---|
| Start → SciMind 4.0 → 5.0 → Path A/B/C | [`RIEMANN_HYPOTHESIS_AND_NUCLEAR_STRUCTURE.md`](RIEMANN_HYPOTHESIS_AND_NUCLEAR_STRUCTURE.md) Sections 6, 7 (Rigor-Audit, Epistemic Synthesis) |
...
| A2ca20/21: TOKEN1 false-positives #2/#3 + echt offen | [`SYNTHESIS_2026_06_10.md`](SYNTHESIS_2026_06_10.md) §T, §U |
| A2ca22: QPU-VQE+VQD-Meilenstein Fez/TOKEN1 | [`RIEMANN_HYPOTHESIS_AND_NUCLEAR_STRUCTURE.md`](RIEMANN_HYPOTHESIS_AND_NUCLEAR_STRUCTURE.md) §10.14, `pt_ququint_vqe_results.json` |
| A2ca23: Pillar 4 GF(5)/Ququint | [`QUANTUM_ARCHITECTURE_IMPLEMENTATION.md`](QUANTUM_ARCHITECTURE_IMPLEMENTATION.md) §"Update 2026-07-21 → 2026-09-24" |
| A2ca24: §Z.11–14 QUQUINT Fez CONFIRMED | [`SYNTHESIS_2026_06_10.md`](SYNTHESIS_2026_06_10.md) §Z.11–14, `pt_ququint_fez_results.json` |
| A2ca25: §Z.15/16 Steelman V1–V4 (κ\* = 62.26) | [`SYNTHESIS_2026_06_10.md`](SYNTHESIS_2026_06_10.md) §Z.15/16 |
| A2ca26: §Z.17/18 Pakete 1–4 (033–036) | [`SYNTHESIS_2026_06_10.md`](SYNTHESIS_2026_06_10.md) §Z.17, §Z.18 |
| A2ca27: H-STAR-5-Ausführung (nächste Phase) | [`pt_hstar5_prereg.json`](pt_hstar5_prereg.json), memory `project-next-phase-hstar5-execution` |
...
**Stand:** 2026-09-24. Aktualisierungen werden in den jeweiligen Sibling-Dokumenten gepflegt.
