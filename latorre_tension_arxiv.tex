...
All code, data, and preregistrations are available at \url{https://github.com/bartman081523/riemann-nuclear-synthesis}. The test suite (584 unit tests) passes. Key files:
\begin{itemize}
