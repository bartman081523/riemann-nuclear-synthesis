...
Historical execution roadmap. Phases 1–3 completed since 2026-06-08; Phase 4 (Im-Bias + statevector-first) completed 2026-06-17; Phase 5 (QUQUINT/Pillar 4 + §Z.11–18) completed 2026-07-21 → 2026-09-24; **Phase 6 (H-STAR-5-Ausführung) completed 2026-09-25 — Phase 6a REFUTED (§Z.20/§10.21)**; **Phase 7 (RAM-Q zyklotomische Ableitung + GF(3)-Deformation) completed 2026-09-26 — H-RAM-Q-1 GENERALIZED (§Z.21/§10.22)**; **Phase 8 (H-RAM-Q-2 q-universelle Asymptotik) completed 2026-09-26 — CONFIRMED (§Z.22/§10.23)**; **Phase 9 (H-RAM-Q-3 Prereg-Freeze A, Hardware-Rauschen) COMPLETED 2026-09-26 — VOID_CALIBRATION: Freeze A (md5 432d43fe) → Stage-2-Aer (v2 PASS, v1 595/702) → Freeze B (w_B 0.0249, ISA_OK 1570 2q) → EIN Fez-Job (darq1stvr3kc73ej96ig, 58×8192, Raw vor Auswertung committed) → alle 13 κ̂ < 0.81 [0.6608–0.8080], Kontrollen grün, Loschmidt-Echo-Deutung (~76 2q), kein Band-Verdict beanspruchbar (§Z.24/§10.25)**; **Phase 10 (H-RAM-Q-3b Minimalregister d=q + Echo-Leiter) COMPLETED 2026-09-26 — REFUTED: Freeze A′ (md5 0b9c9968) → Stage-2b-Aer + Re-Freeze R1 → Freeze B′ (w_B′ 0.02787, ISA2_OK 493 2q) → EIN Fez-Job (dartdg5vr3kc73ejcrgg, 90×8192, Raw vor Auswertung committed) → gefrorene Auswertung: Kalibrier-Ziel EINLÖST (alle 13 κ̂ ≥ 0.81), 13/13 unter c(κ̂)−w_B′ einseitig (Suppression), auch v2 verfehlt (alle res_v2 negativ), Kontrollen grün — erster verdict-tragend REFUTED der RAM-Q-Serie (§Z.25/§10.26)**.
...
- **Status:** ✅ Freeze A vollzogen (md5 `432d43fe1bc9e2594efd3b35266d2d81`, `pt_ram_q_hardware.py` + `pt_ram_q_hardware_prereg.json` + 12 Tests; 728 grün).
- **Status 2 (Stage-2-Aer-Bein, 0 QPU):** ✅ DONE — `pt_ram_q_hardware_aer.py`, 13 Punkte × 6 Stresslevel, exact + sampled = 702 Zellen, gefrorenes STRESS-Modell (RO 0.01 + CZ-Depolarisierung ratio×p1 auf nativem cz). **v2-Gesetz PASS:** 351 Domain-Zellen, max |res_v2| 0.0276 < TOL_FORM 0.03, 0 Verletzungen; **v1-Gesetz MASSIV gescheitert (595/702)** — der dokumentierte Re-Freeze-Trigger als Diskriminanz. b_P in den registrierten Arm-Ranges (q3 0.851–0.898, q5 0.662–0.713), ratio_ro-Anker exakt (ANCHOR_PIN). Run-1-Regression (Tupel-Keys in `intercepts` → JSON-Crash nach 104 s Rechenzeit) gefixt + als Serialize-Vertragstest gepinnt.
- **Status 3 (Freeze B):** ✅ COMMITTET — **w_B = 0.0249** = Domain-q97.5 (κ̂ ≥ 0.81-Zellen; KAPPA_CEILING war in Freeze A vor jedem Stress-Kontakt gefroren). Dokumentiertes Amendment: der literal-frozen Text ("q97.5 über ALLE Punkte × Stresslevel") ist selbst-defeatierend — alle-Levels-q97.5 = 0.2304 (Sub-Domain-Schwanz, Residuen bis 0.249, das Gesetz versagt strukturimmanent unter 0.81, verdict_map verlangt κ̂ ≥ 0.81 für CONFIRMED); beide Lesarten mit Zahlen registriert, Gate gegen den UNGECLIPPTEN Wert (`w_b_raw_q975` = 0.0249 ≤ w_A = 0.05, `w_b_gate_ok` True), Zentrum c(κ) unverändert gefroren. **ISA-Report ECHT gegen ibm_fez (TOKEN1, Auth only):** 58 Circuits, total 1570 2q (Ceiling 6000), max 76/Circuit (Ceiling 120), ISA_OK, bit-identisch zur FakeFez-Offline-Prognose. Suite 791 grün (test_count 728 → 791).
- **Status 4 (Fez-QPU-Job + gefrorene Auswertung):** ✅ DONE — **EIN Fez-Job** (TOKEN1, `darq1stvr3kc73ej96ig`, 58 Circuits × 8192), Raw + Job-ID + counts_md5 `d19f4a563d88e0cf3ffd4b187a10ca73` committed (`b5ba31a`) **VOR** der Auswertung. **VERDICT `H-RAM-Q-3_VOID_CALIBRATION`** (`ff5e2d5`): alle 13 Punkte κ̂ < 0.81 [0.6608–0.8080], Kontrollen t3 (max 8.88e-16)/t4/t5/t6/md5 ALLE grün → kalibrierbedingt, nicht pipeline-bedingt; 0 Amplification, 7/13 scharf (nicht verdict-tragend); κ̂-Defizit = Loschmidt-Echo (~76 2q Gates, per-2q-Survival ≈ 0.9967, ε_C ≈ 0.17 % > 0.10-Garantie), nicht Readout (0.33–0.39 %/Qubit); Tiefe-Konsistenz min κ̂(4q) 0.7403 > max κ̂(5q) 0.6886. Hypothese unangetastet-unbestätigt, KEIN Band-Verdict beanspruchbar; nächste Iteration (Echo kürzen / ε_C ins Zentrum) = NEUES Prereg. Suite 831 grün (test_count 791 → 831).
...
## Phase 10 (COMPLETED — REFUTED): H-RAM-Q-3b Prereg-Freeze A′ → Minimalregister-Lauf — Minimalregister d=q + Echo-Tiefen-Leiter (Branch `ram-q-zyklizitaet`, 2026-09-26, 1 QPU-Job)

- **Goal (User-Direktive, wörtlich registriert im Payload `user_anchor`):** "Option A über die bewiesene d-Invarianz ist der einzig saubere Weg, das Hardware-Design zu reparieren, ohne die Epistemik zu verbiegen. Indem wir das Register auf die minimalen Repräsentanten (q=3 auf d=3, q=5 auf d=5) verdichten, schrumpft die Echo-Tiefe drastisch. So machen wir die unverändert gefrorene Garantie κ ≥ 0.81 physikalisch einlösbar, anstatt die Metrik nach einem Void rückwirkend aufzuweichen." Die Wahl neuer P-Werte (alte 13 sind durch die Reskalierung vorbelastet), die Echo-Tiefen-Leiter (gemessenes Dämpfungsgesetz statt starrer (1−ε)²-Annahme), hardwareseitiger d-Invarianz-Test über Lauf 1/2, Option B NUR als nachgelagerte Fallback-Lesart.
- **Design-Hebel (d-Invarianz, 041 T3 exakt):** das Register ist INSTRUMENT, nicht Hypothese — die 13 VERDICT-Punkte tragen die Minimalrepräsentanten q=3 auf d=3 (2 Qubits, 4 Labels, 3 real/1 idle, Echo ~2–6 2q) und q=5 auf d=5 (3 Qubits, 8 Labels, 5 real/3 idle, Echo ~8–12 2q) mit IDENTISCHEN Ratio-Vorhersagen (13/13 identisch über d=q, d=q², d=q³, tol 1e-12); κ̂ ~0.94–0.98 (q3) / ~0.93–0.96 (q5) löst die UNVERÄNDERT gefrorene Garantie 0.81 mit Marge ein. **Familienbedingung q | d:** d=P liegt AUSSERHALB (Primzahl P landet im Label P mod P = 0 statt Klasse P mod q) — `arm_point` verweigert d=P via closed_form-Guard.
- **Neue P (registrierte Regel, deterministisch, vor jeder Messung):** P_neu = kleinste Primzahl > P_alt + 30 → q3: [149, 197, 251, 347, 433, 577, 659, 761], q5: [433, 499, 577, 631, 659]; Ankerpunkte der Leiter: 149/433. Alte 13 P NUR Diagnostik-Bein (am Minimalregister nie gemessen → nicht vorbelastet; Leckage dokumentiert).
- **Echo-Tiefen-Leiter (Kalibrier-Diagnostik, nicht verdict-tragend):** r-fache (Prep + exakte Inverse)-Blöcke r ∈ {1,2,4,8} je Arm am Ankerpunkt; r=1 geteilt mit dem gepaarten Loschmidt-Circuit; log κ_r vs r (LSQ) → gemessenes Dämpfungsgesetz für Fallback-B statt starrer (1−ε)²-Annahme.
- **Shuffle-Inertness-Theorem:** bei d=q ist der Fold die Identität; Label-Permutation lässt Σ N² invariant → expected_share == share_true_reg EXAKT — die Phase-9-Shuffle-Kontrolle wäre am Minimalregister IM Prime-Band → ersetzt durch Composite- (beide Arme) + Uniform-Null-Kontrollen (beide Arme) mit exakten Erwartungen (T4b als Theorem registriert, KEIN Circuit).
- **Sicherung UNVERÄNDERT aus Phase 9 (md5 432d43fe):** SHOTS 8192, K_REPEATS 3, w_A 0.05 (Freeze B′ nur Verengung), KAPPA_CEILING 0.81 (VOID-Regel exakt gleich), TOL_FORM 0.03, W_B_FLOOR 0.01, ISA-Ceilings 120/6000; Rauschgesetz ratio_hw = κ·(1−1/S)·ratio_true + L_q mit gefrorenem Zentrum. **Budget:** 90 Circuits (Struktur 39, Loschmidt 13, Leiter 6, Diagnostik 13+13, Kontrollen 4, Readout-Cal 2) × 8192 = 737 280 Shots, EIN Fez-Job (TOKEN1). **Diagnostik-Regel:** |res_v1(run 2, d=q) − res_v1(run 1, d=q^k)| ≤ W_CROSS = 0.09 (= 2√2·std_run1 = 0.0825, aufgerundet; max_abs 0.0668, std 0.0292 aus committed run-1-Eval).
- **Status:** ✅ Freeze A′ vollzogen — `pt_ram_q_hardware2.py` + `pt_ram_q_hardware2_prereg.json` (Status REGISTERED_NOT_MEASURED, payload_md5 `5b91119b925ae365bcd0618a2a15fa30`) + 24 Tests; Suite 855 grün (test_count 831 → 855); dokumentierter Re-Freeze VOR dem Commit (Label-Arithmetik q3: 2 Qubits = 4 Labels, 1 idle — nicht 8/5). **Ergebnis (10d, COMPLETED):** VERDICT `H-RAM-Q-3b_REFUTED` (§Z.25/§10.26) — Kalibrier-Ziel EINLÖST (alle 13 κ̂ ≥ 0.81: q3 0.9786–0.9904, q5 0.9196–0.9286 — kein Void wie Phase 9), 13/13 unter c(κ̂)−w_B′ [−0.0938..−0.0341] EINSEITIG, 0 Amplification, auch v2 verfehlt ([−0.0630..−0.0159] alle negativ, max 0.0630 > w_B′ 0.02787), Kontrollen ALLE grün (t3 3.55e-15, t4 unter der 0.81-Ecke-Kante, t5 493 2q/max 84, t6, md5 16ca44bd); Echo-Leiter κ_block q3 0.9879 / q5 0.9128; d-Inv-Bein HARDWARE-D_INVARIANZ_VERLETZT (7/13, max |Δ| 0.1701, 11/13 negativ = v1-Signatur), klassischer Kern bit-exakt; erster verdict-tragend REFUTED der RAM-Q-Serie mit vollständig grünen Kontrollen — kalibrierseitig sauber, gesetzesseitig falsifiziert (36 neue Tests, 981 grün).
- Cross-Ref: `~/.claude/plans/riemann-phase-ram-q-zyklizitaet.md` Phase 10.
...
9. H-RAM-Q-3 Prereg-Freeze A (Hardware-Rauschen) → ✅ DONE — VOID_CALIBRATION (Phase 9, 2026-09-26, Branch `ram-q-zyklizitaet`); 9b. Stage-2-Aer-Bein → ✅ DONE (13×6-Grid, v2 PASS / v1-Trigger 595/702); 9c. Freeze B → ✅ COMMITTET (w_B 0.0249 ≤ w_A, ISA_OK 1570 2q); 9d. EIN Fez-Job + gefrorene Auswertung → ✅ DONE — VERDICT `H-RAM-Q-3_VOID_CALIBRATION` (alle 13 κ̂ < 0.81, Kontrollen grün, Loschmidt-Echo-Deutung, kein Band-Claim)
10. H-RAM-Q-3b Prereg-Freeze A′ (Minimalregister d=q + Echo-Leiter) → ✅ REGISTERED — NOT MEASURED (Phase 10, 2026-09-26, Branch `ram-q-zyklizitaet`, md5 `5b91119b`, 90 Circuits, 0 QPU); 10b. Stage-2-Aer-Bein am Minimalregister (0 QPU) → ✅ DONE mit **Re-Freeze R1** (md5 `5b91119b` → `0b9c9968`, 0 QPU, Register/Konstanten unangetastet: das Erst-Grid v2-Form-Gate scheiterte nur am per-Zell-Max des sampled-Beins 0.0396 = 3.4σ Estimator-Rauschen, exact-Zentrum max 0.0022 — zweistufige Lesart frozen: exact-Gate via TOL_FORM 0.03, sampled-Gate via w_B′-q97.5 ≤ W_A, per-Zell-Max = Diagnostik KEIN Gate; v1 fail 702/702, w_B′ 0.0279 unclipped gate ok, Echo-Leiter-Gesetz max log-res 0.012 in 9 Domain-Levels vs sub-domain Bruch 0.32); 10c. Freeze B′ (w_B′ + ISA-Report) → ✅ COMMITTET (Phase-9-Präzedenz: Payload-md5 `0b9c9968` unangetastet, w_B′ lebt im committed Stage-2b-Results + ISA-Report; ECHTER ibm_fez-ISA-Report ISA_OK — 90 Circuits, total 493 2q (Ceiling 6000), max 84 = Leiter r8 q5 (Ceiling 120), q5-Loschmidt 14 2q auf echtem Target vs 8 Aer-Basis = Routing-Surplus, q3 2 unangetastet); 10d-Vorbereitung. Fez-Runner-2 → ✅ COMMITTET (5ac74f6, 0 QPU: `pt_ram_q_hardware2_qpu.py` Mirror des Phase-9-Runners — EIN SamplerV2-Job 90×8192, DD XX, Transpilation bit-identisch zum ISA2-Report 493/84, job_id sofort persistiert `pt_ram_q_fez2_job_id.txt`, Raw-Commit VOR Auswertung, TOKEN1, 13 Vertraege-Tests, 943 grün); 10d. EIN Fez-Job + gefrorene Auswertung → ✅ DONE — VERDICT `H-RAM-Q-3b_REFUTED` (Phase 10d, 2026-09-26, Branch `ram-q-zyklizitaet`: Fez-Job dartdg5vr3kc73ejcrgg 90×8192 TOKEN1, Raw + counts_md5 16ca44bd committed 38a975b VOR Auswertung, Inventar-Buchung 047e39b mit Filter-Amendment Hex-Run ≥ 21; gefrorene Auswertung 7483a11 — alle 13 κ̂ ≥ 0.81 [q3 0.9786–0.9904, q5 0.9196–0.9286: Kalibrier-Ziel EINLÖST, kein Void], 13/13 unter c(κ̂)−w_B′ [−0.0938..−0.0341] EINSEITIG, 0 Amplification, auch v2 verfehlt [−0.0630..−0.0159] alle negativ, Kontrollen grün (t3 3.55e-15), Echo-Leiter κ_block q3 0.9879/q5 0.9128, d-Inv-Bein VERLETZT 7/13 max 0.1701 = v1-Signatur, erster verdict-tragend REFUTED der RAM-Q-Serie, 36 neue Tests, 981 grün — Ergebnis-Nummerierung §Z.25/§10.26)