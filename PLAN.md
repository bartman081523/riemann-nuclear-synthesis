...
## Phase 10 (REGISTERED — NOT MEASURED): H-RAM-Q-3b Prereg-Freeze A′ — Minimalregister d=q + Echo-Tiefen-Leiter (Branch `ram-q-zyklizitaet`, 2026-09-26, 0 QPU)
...
- **Status:** ✅ Freeze A′ vollzogen — `pt_ram_q_hardware2.py` + `pt_ram_q_hardware2_prereg.json` (Status REGISTERED_NOT_MEASURED, payload_md5 `5b91119b925ae365bcd0618a2a15fa30`) + 24 Tests; Suite 855 grün (test_count 831 → 855); dokumentierter Re-Freeze VOR dem Commit (Label-Arithmetik q3: 2 Qubits = 4 Labels, 1 idle — nicht 8/5). **Nächste Schritte:** Stage-2-Aer-Bein am Minimalregister (0 QPU, Form-Validierung inkl. Wraparound-Fold) → Freeze B′ (w_B′ + ISA-Report) → EIN Fez-Job → gefrorene Auswertung; Ergebnis-Nummerierung dann §Z.25/§10.26.
